...
def run(DAYS):
    ...
    model.fc = nn.Linear(num_ftrs, 1)  # Single continuous output
    ...
    np.save('/home/jupyter-juiyun/Digital_Health/resnet_code/resnet_'+str(DAYS)+'d_preds.npy', val_preds)
    np.save('/home/jupyter-juiyun/Digital_Health/resnet_code/resnet_'+str(DAYS)+'d_labels.npy', val_labels_binary)


if __name__ == "__main__":
    for d in [1,5,7,30, 3]:
        print(f"Starting processing for {d} days...")
        run(d)
